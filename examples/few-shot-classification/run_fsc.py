...
from rlprompt.modules import SQLModuleConfig, make_sql_module, QModuleConfig, make_q_module
...
config_list = [PromptedClassificationRewardConfig,
                ...
                SinglePromptModelConfig, SQLModuleConfig, QModuleConfig, TrainerConfig]
